...
namespace Task_Students
{
    class Program
    {
        ...
        private static void ShowAverageGrades()
        {
        ...
        {
            Console.WriteLine("Please enter Ident Num of Student");

            string facNum = Console.ReadLine();

            while (!CheckIfFacIsValid(facNum))
            {
        ...
        private static bool CheckIfFacIsValid(string facNum)
        {
            return true;
        }
        ...
        private static void DeleteByEGN()
        {
            ...
            if (studentsDic.ContainsKey(identNum))
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\DemoFiles\Students.txt"))
                {
        ...
        private static void ShowAllStudents()
        {
            ...
            foreach (string student in students)
            {
                ...
                Console.WriteLine($"{firstName} {lastName} {facNum} {grade1}, {grade2}, {grade3}, {grade4}, {grade5}, {grade6}, {grade7}, {grade8}, {grade9}, {grade10}");
            }
        }
